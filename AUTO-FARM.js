...
(() => {
  ...
  function injectCSS(){
    const T = CFG.THEME;
    const css = `
      .wbq-root{position:fixed;z-index:999999;display:flex;align-items:center;justify-content:center;background:${T.panel};color:${T.text};border:1px solid ${T.border};box-shadow:0 12px 30px rgba(0,0,0,.4);border-radius:14px;overflow:hidden;touch-action:none}
